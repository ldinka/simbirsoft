...
class frequencyDictionary {
    ...
    public function init()
    {
        ...
        else
        {
            ...
            $this->view->showTemplate("fd.table", array("submit_link"=>$submit_link, "number"=>$number, "result_arr"=>$result_arr));
        }

        if ($pages_fd>1)
        {
            $this->view->showTemplate("fd.pages", array("pages_fd"=>$pages_fd, "number"=>$number, "submit_link"=>$submit_link, "what"=>$what, "order"=>$order));
        }
    }
}
